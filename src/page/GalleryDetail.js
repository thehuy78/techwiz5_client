...
export default function GalleryDetail() {
  ...
  return detail && (
    <div className='gallery_detail_page'>
      ...
      <section className='sec1_1' style={{ backgroundImage: `url(${require('../assets/images/background/badrooom.jpg')})` }}>
        ...
        <div className='sec_2_container'>
          <div className='top'>
            ...
            <div className='content'>
              ...
              <p className='discription'>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC</p>
      ...
      <section className='sec4'>
        <div className='sec_4_container'>
          <p className='title_sec4_gallerydetail'>
            Product In Gallery
          </p>
